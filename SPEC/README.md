...
7. [SPEC-006 GitHub 发布与完整演示规范](./SPEC-006-github-release-and-demo-v1.md)
8. 与当前任务相关的 ADR 和 [测试样例目录](./testcases/README.md)
...
| SPEC-006 | [GitHub 发布与完整演示规范 V1.0](./SPEC-006-github-release-and-demo-v1.md) | IMPLEMENTING | 完整网页演示、公开文档、CI、GitHub治理和v0.1.0发布 |
